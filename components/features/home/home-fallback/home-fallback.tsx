...
/**
 * The original hardcoded homepage. Rendered only when no admin-managed section resolves to
 * content, so the site never falls back to a blank page.
 */
export const HomeFallback = async () => {
